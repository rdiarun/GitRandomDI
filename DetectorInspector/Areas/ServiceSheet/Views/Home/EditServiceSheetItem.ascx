<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<DetectorInspector.Areas.ServiceSheet.ViewModels.ServiceSheetViewModel>" %>
...
<div class="ui-tabs-panel ui-widget-content ui-corner-bottom" id="details-tab" style="padding: 0px 0px 0px 0px">
    <div class="full">
        ...
        <% 
            ...
            %>
            <tr>
                <td nowrap="nowrap" style="vertical-align:bottom;"><a href="#" onclick="deleteServiceSheetItemWithID(<%=serviceSheetItem.Id.ToString() %>,this);return false;"><%= Html.Image("delete", "~/Content/Images/delete.png", "Delete", "Delete", "alert()") %></a></td>
	            <td nowrap="nowrap">
	            ...
	            <td nowrap="nowrap"><%= Html.DropDownList(string.Format("ServiceSheetItem.DetectorType.Id.{0}", counter), new SelectList(Model.DetectorTypes, "Id", "Name", serviceSheetItem.DetectorType!=null?serviceSheetItem.DetectorType.Id.ToString():string.Empty), new { style = "width: 120px;" })%></td>
                ...
                <td nowrap="nowrap" style="padding:0 0px 0 23px"><%= Html.CheckBox(string.Format("ServiceSheetItem.IsReplacedByElectrician.{0}", counter), serviceSheetItem.IsReplacedByElectrician, new { disabled = "disabled" })%></td>
