<%@ Page Title="Role Management" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="DetectorInspector.Views.ViewPage" %>
...
<div class="buttons">
	 <%= Html.ActionButton("Add", "Edit", "Role", new { id = 0 }, new { @class = "button ui-corner-all ui-state-default" })%>		 
</div>

<% using (Html.BeginForm("Delete", "Role", FormMethod.Post, new { id = "delete-form" }))
   {%>
...
<div id="dialog" style="display:none;" title="Delete Item">
	<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Are you sure you want to delete the Role &quot;<span id="deleteTitle"></span>&quot;?</p>
</div>
