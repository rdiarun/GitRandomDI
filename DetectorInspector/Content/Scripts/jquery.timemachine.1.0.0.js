...
(function ($) {
    ...
    */
    ...
    $.fn.timemachine.defaults =
	{
	    ...
	    top: '', // specify the position of left most pixel
    ...
    time_function = {
        ...
        create: function (timemach, config, variable) {
            ...
            // Creating the Div.
            var timeMachDiv = '<br><div id="' + this.timeMachId + '" style="display:none;"></div>';
            ...
            $('body').bind('click', function (e) {
                ...
                if (!($(e.target).attr('id') == $(timemach).attr('id') || variable.divID + '_' + $(timemach).attr('id') == $(e.target).parent().parent().parent().attr('id') || variable.divID + '_' + $(timemach).attr('id') == $(e.target).parent().parent().parent().parent().attr('id'))) {
        ...
        display_data: // Used to display data in appropriate drop downs.
			...
			display_ok: function (timemach, config, variable) {
			    var okButton = '<button class="button ui-corner-all ui-state-default" type="button" id="' + variable.divID + '_'
            ...
            if ($(timemach).val() != undefined && $(timemach) != null
                ...
                for (var i = 0; i < (inputVal.length); i++) {
                    ...
                    if (isNumParseComplete == true) {
                        ...
                        if (charList < 10 && charList.length == 1) {	// If value is less than 10, append a zero for aesthetic purposes.
                            charList = '0' + charList;
                        }
